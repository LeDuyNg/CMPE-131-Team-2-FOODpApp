...
16. User can have get a randomly generated recipe.
17. User is able to delete their profile and all of their recipes will be auto deleted.
18. User can see random recipe of the day in homepage.
...
- **Alternate Sequence:**
    ...
    ---
16. **Use Case Name:** Get randomly genrated recipe
- **Summary:** User can have get a randomly generated recipe.
- **Actor(s):** User, System
- **Pre-condition:** User is logged in
- **Trigger:** User clicks on **Get new recipe** button.
- **Primary Sequence:**
	1. User logs in
	2. User clicks “Get new recipe”
	3. System makes a call to an API and retrieve data for a new recipe
	4. System displays the new recipe's data
	5. User clicks **Add to my recipe**
	6. System redirects users to create a new recipe page, with title, description, ingredients, instructions fields filled out.
    7. User clicks **Submit recipe**.
    8. System stores new recipe into database.
    9. System redirects user to homepage.

- **Primary Post-conditions:** System stores new recipe generated by API into database.
- **Alternate Sequence:**
	- **5a. User clicks 'Return'**
		- System redirects user to homepage.
    - **7a. User clicks 'Home'**
		- System redirects user to homepage.
	---
